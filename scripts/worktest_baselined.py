...
os.environ["WANDB_NAME"] = "gpt2_pathology_trained_on_non"      
MODEL_DIR = "../models/gpt2_pathology_trained_on_non"
...
trainer = Trainer(
    ...
    callbacks=[EarlyStoppingCallback(early_stopping_patience=5)]  # 3b) early stopping
)
...
checkpoint_path = f"{MODEL_DIR}/checkpoint-976"
